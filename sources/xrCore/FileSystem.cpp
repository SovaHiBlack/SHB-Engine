...
//------------------------------------------------------------------------------
bool EFS_Utils::GetOpenName(pcstr initial,  string_path& buffer, int sz_buf, bool bMulti, pcstr offset, int start_flt_ext )
{
...
//----------------------------------------------------
pcstr EFS_Utils::AppendFolderToName(LPSTR tex_name, int depth, BOOL full_name)
{
	string256 _fn;
...
pcstr EFS_Utils::AppendFolderToName(pcstr src_name, LPSTR dest_name, int depth, BOOL full_name)
{
...
pcstr EFS_Utils::GenerateName(pcstr base_path, pcstr base_name, pcstr def_ext, LPSTR out_name)
{
    int cnt = 0;
	string_path fn;
    if (base_name)	
