...
//----------------------------------------------------
pcstr EFS_Utils::AppendFolderToName(pstr tex_name, int depth, BOOL full_name)
{
	string256 _fn;
...
pcstr EFS_Utils::AppendFolderToName(pcstr src_name, pstr dest_name, int depth, BOOL full_name)
{
