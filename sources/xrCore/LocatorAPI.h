...
private:
	...
	void						ProcessOne		(pcstr path, void* F);
...
private:
			void				check_cached_files	(LPSTR fname, const file &desc, pcstr& source_name);
	...
	template <typename T>
			void				file_from_cache		(T *&R, LPSTR fname, const file &desc, pcstr& source_name);
...
public:
	...
	xr_vector<LPSTR>*			file_list_open		(pcstr initial, pcstr folder,	u32 flags=FS_ListFiles);
	xr_vector<LPSTR>*			file_list_open		(pcstr path,					u32 flags=FS_ListFiles);
