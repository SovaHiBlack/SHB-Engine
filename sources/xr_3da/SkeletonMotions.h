...
const f32		SAMPLE_FPS = 30.0f;
const f32		SAMPLE_SPF = (1.0f / SAMPLE_FPS);
const f32		KEY_Quant = 32767.0f;
const f32		KEY_QuantI = 1.0f / KEY_Quant;
...
public:
	...
	IC f32				Dequantize(u16 V)
	{
		return (f32(V) / 655.35f);
	}
	IC u16					Quantize(f32 V)
	{
