...
void	CObject::spatial_update(f32 eps_P, f32 eps_R)
{
	...
	if (PositionStack.empty( ))
	{
		// Empty
		bUpdate = TRUE;
		PositionStack.push_back(SSavedPosition( ));
...
CObject::SSavedPosition CObject::ps_Element(u32 ID) const
{
	VERIFY(ID < ps_Size( ));
