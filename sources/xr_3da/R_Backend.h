...
public:
	...
	ICF void set_c(R_constant* C, const fMatrix4x4& A)
	{
		if (C)
		{
			constants.set(C, A);
	...
	ICF void set_c(R_constant* C, f32 x, f32 y, f32 z, f32 w)
	{
		if (C)
		{
	...
	ICF void set_ca(R_constant* C, u32 e, const fMatrix4x4& A)
	{
		if (C)
		{
	...
	ICF void set_ca(R_constant* C, u32 e, f32 x, f32 y, f32 z, f32 w)
	{
		if (C)
		{
	...
	ICF void set_c(pcstr n, const fMatrix4x4& A)
	{
		if (ctable)
		{
	...
	ICF void set_c(pcstr n, const fVector4& A)
	{
		if (ctable)
		{
			set_c(&*ctable->get(n), A);
	...
	ICF void set_c(pcstr n, f32 x, f32 y, f32 z, f32 w)
	{
		if (ctable)
		{
	...
	ICF void set_ca(pcstr n, u32 e, const fMatrix4x4& A)
	{
		if (ctable)
		{
	...
	ICF void set_ca(pcstr n, u32 e, const fVector4& A)
	{
		if (ctable)
		{
			set_ca(&*ctable->get(n), e, A);
	...
	ICF void set_ca(pcstr n, u32 e, f32 x, f32 y, f32 z, f32 w)
	{
		if (ctable)
		{
	...
	ICF void set_c(shared_str& n, const fMatrix4x4& A)
	{
		if (ctable)
		{
			set_c(&*ctable->get(n), A);
	...
	ICF void set_c(shared_str& n, f32 x, f32 y, f32 z, f32 w)
	{
		if (ctable)
		{
			set_c(&*ctable->get(n), x, y, z, w);
	...
	ICF void set_ca(shared_str& n, u32 e, const fMatrix4x4& A)
	{
		if (ctable)
		{
			set_ca(&*ctable->get(n), e, A);
	...
	ICF void set_ca(shared_str& n, u32 e, f32 x, f32 y, f32 z, f32 w)
	{
		if (ctable)
		{
			set_ca(&*ctable->get(n), e, x, y, z, w);
...
#ifdef DEBUG
	void dbg_Draw(D3DPRIMITIVETYPE T, FVF::L* pVerts, s32 vcnt, u16* pIdx, s32 pcnt);
	void dbg_Draw(D3DPRIMITIVETYPE T, FVF::L* pVerts, s32 pcnt);
	IC void dbg_DrawAABB(fVector3& T, f32 sx, f32 sy, f32 sz, u32 C)
	{
		fVector3 half_dim;
	...
	IC void dbg_DrawTRI(fMatrix4x4& T, fVector3* p, u32 C)
	{
