...
void	CBlender_Compile::SetParams(s32 iPriority, bool bStrictB2F)
{
...
void	CBlender_Compile::StageSET_TMC(pcstr T, pcstr M, pcstr C, s32 UVW_channel)
{
	Stage_Texture(T);
...
void	CBlender_Compile::Stage_Matrix(pcstr name, s32 iChannel)
{
