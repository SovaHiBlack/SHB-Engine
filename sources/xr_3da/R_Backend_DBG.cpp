...
#ifdef DEBUG
void CBackend::dbg_Draw(D3DPRIMITIVETYPE T, FVF::L* pVerts, s32 vcnt, u16* pIdx, s32 pcnt)
{
	OnFrameEnd( );
...
void CBackend::dbg_Draw(D3DPRIMITIVETYPE T, FVF::L* pVerts, s32 pcnt)
{
	OnFrameEnd( );
	CHK_DX(HW.pDevice->SetFVF(FVF::F_L));
...
void CBackend::dbg_DrawOBB(fMatrix4x4& T, fVector3& half_dim, u32 C)
{
	...
	FVF::L aabb[8];
	aabb[0].set(-1.0f, -1.0f, -1.0f, C); // 0
	aabb[1].set(-1.0f, +1.0f, -1.0f, C); // 1
	aabb[2].set(+1.0f, +1.0f, -1.0f, C); // 2
	aabb[3].set(+1.0f, -1.0f, -1.0f, C); // 3
	aabb[4].set(-1.0f, -1.0f, +1.0f, C); // 4
	aabb[5].set(-1.0f, +1.0f, +1.0f, C); // 5
	aabb[6].set(+1.0f, +1.0f, +1.0f, C); // 6
	aabb[7].set(+1.0f, -1.0f, +1.0f, C); // 7
...
void CBackend::dbg_DrawEllipse(fMatrix4x4& T, u32 C)
{
	f32 gVertices[ ] =
	{
		...
		-0.1464f,  0.3536f,  0.9239f,
		-0.2706f,  0.2706f,  0.9239f,
		-0.3536f,  0.1464f,  0.9239f,
		...
		-0.2706f,  0.6533f,  0.7071f,
		-0.5000f,  0.5000f,  0.7071f,
		-0.6533f,  0.2706f,  0.7071f,
		...
		-0.3536f,  0.8536f,  0.3827f,
		-0.6533f,  0.6533f,  0.3827f,
		-0.8536f,  0.3536f,  0.3827f,
	...
	const s32 vcnt = sizeof(gVertices) / (sizeof(f32) * 3);
	FVF::L verts[vcnt];
