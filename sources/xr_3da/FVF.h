...
namespace FVF
{
	struct L
	{
		...
		IC void		set(f32 x, f32 y, f32 z, u32 C)
		{
			p.set(x, y, z);
			color = C;
		}
		IC void		set(const fVector3& _p, u32 C)
		{
			p.set(_p);
			color = C;
		}
	...
	struct V
	{
		...
		IC void		set(f32 x, f32 y, f32 z, f32 u, f32 v)
		{
			p.set(x, y, z);
			t.set(u, v);
		}
		IC void		set(const fVector3& _p, f32 u, f32 v)
		{
			p.set(_p);
			t.set(u, v);
		}
	...
	struct LIT
	{
		...
		IC void		set(f32 x, f32 y, f32 z, u32 C, f32 u, f32 v)
		{
			p.set(x, y, z);
			color = C;
			t.set(u, v);
		}
		IC void		set(const fVector3& _p, u32 C, f32 u, f32 v)
		{
			p.set(_p);
			color = C;
			t.set(u, v);
	...
	struct TL0uv
	{
		...
		IC void	set(f32 x, f32 y, u32 c)
		{
			set(x, y, 0.0001f, 0.9999f, c);
		}
		IC void	set(s32 x, s32 y, u32 c)
		{
			set(f32(x), f32(y), 0.0001f, 0.9999f, c);
		}
	...
	struct TL
	{
		...
		IC void	set(f32 x, f32 y, u32 c, fVector2& t)
		{
			set(x, y, 0.0001f, 0.9999f, c, t.x, t.y);
		}
		IC void	set(f32 x, f32 y, u32 c, f32 u, f32 v)
		{
			set(x, y, 0.0001f, 0.9999f, c, u, v);
		}
		IC void	set(s32 x, s32 y, u32 c, f32 u, f32 v)
		{
			set(f32(x), f32(y), 0.0001f, 0.9999f, c, u, v);
		}
	...
	struct TL2uv
	{
		...
		IC void	set(f32 x, f32 y, u32 c, fVector2& t0, fVector2& t1)
		{
			set(x, y, .0001f, .9999f, c, t0.x, t0.y, t1.x, t1.y);
		}
		IC void	set(f32 x, f32 y, f32 z, f32 w, u32 c, fVector2& t0, fVector2& t1)
		{
			set(x, y, z, w, c, t0.x, t0.y, t1.x, t1.y);
		}
		IC void	set(f32 x, f32 y, u32 c, f32 u, f32 v, f32 u2, f32 v2)
		{
			set(x, y, .0001f, .9999f, c, u, v, u2, v2);
		}
		IC void	set(s32 x, s32 y, u32 c, f32 u, f32 v, f32 u2, f32 v2)
		{
