...
public:
	...
	inline CCameraBase* cam_Active( )
	{
		return cameras[cam_active];
	}
	inline CCameraBase* cam_FirstEye( )
	{
...
public:
	...
	const char* GetDefaultActionForObject( )
	{
...
protected:
	...
	Fvector3		IPosS, IPosH, IPosL;	//положение актера после интерполяции Бизье, Эрмита, линейной

#ifdef DEBUG
	using VIS_POSITION = xr_deque<Fvector3>;
...
public:
	...
	virtual void			RenderText(const char* Text, Fvector3 dpos, float* pdup, u32 color);
	...
	inline void			lock_accel_for(u32 time)
	{
...
protected:
	unsigned short							m_iLastHitterID;
	unsigned short							m_iLastHittingWeaponID;
	...
	virtual bool			Check_for_BackStab_Bone(unsigned short element);
...
public:
	void				SetActorVisibility(unsigned short who, float value);
