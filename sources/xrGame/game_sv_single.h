...
//	virtual		CSE_Abstract*		get_entity_from_eid		(unsigned short id);


	virtual		void				OnCreate				(unsigned short id_who);
	virtual		BOOL				OnTouch					(unsigned short eid_who, unsigned short eid_what, BOOL bForced = FALSE);
	virtual		void				OnDetach				(unsigned short eid_who, unsigned short eid_what);
