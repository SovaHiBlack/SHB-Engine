...
class CPHCharacter : public CPHObject, public CPHSynchronize, public CPHDisablingTranslational
...
{
public:
	unsigned __int64						m_creation_step;
	bool					b_exist;
...
////////////////////////// dynamic
	...
	dBodyID				m_body;
	CPHShellHolder* m_phys_ref_object;
