...
void CScriptEngine::process_file_if_exists	(pcstr file_name, bool warn_if_not_exist)
{
...
void CScriptEngine::process_file	(pcstr file_name)
{
	process_file_if_exists	(file_name,true);
}

void CScriptEngine::process_file	(pcstr file_name, bool reload_modules)
{
...
bool CScriptEngine::no_file_exists	(pcstr file_name, u32 string_length)
{
...
void CScriptEngine::add_no_file		(pcstr file_name, u32 string_length)
{
