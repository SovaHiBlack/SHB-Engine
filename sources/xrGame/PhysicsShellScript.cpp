...
void CPhysicsShell::script_register(lua_State *L)
{
	module(L)
		[
			...
			.def("get_element_by_bone_name",	(CPhysicsElement*(CPhysicsShell::*)(const char*))(&CPhysicsShell::get_Element))
			.def("get_element_by_bone_id",		(CPhysicsElement*(CPhysicsShell::*)(unsigned short))(&CPhysicsShell::get_Element))
			.def("get_element_by_order",		&CPhysicsShell::get_ElementByStoreOrder)
			.def("get_elements_number",			&CPhysicsShell::get_ElementsNumber)
			.def("get_joint_by_bone_name",		(CPhysicsJoint*(CPhysicsShell::*)(const char*))(&CPhysicsShell::get_Joint))
			.def("get_joint_by_bone_id",		(CPhysicsJoint*(CPhysicsShell::*)(unsigned short))(&CPhysicsShell::get_Joint))
