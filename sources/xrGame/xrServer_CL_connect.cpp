...
void CServer::SendConnectResult(IClient* CL, unsigned char res, unsigned char res1, char* ResultStr)
{
	CNetPacket	P;
...
void CServer::OnBuildVersionRespond(IClient* CL, CNetPacket& P)
{
	unsigned short Type;
	P.r_begin(Type);
	unsigned __int64 _our = FS.auth_get( );
	unsigned __int64 _him = P.r_u64( );
