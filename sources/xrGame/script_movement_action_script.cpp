...
void CScriptMovementAction::script_register(lua_State *L)
{
	...
	[
		class_<CScriptMovementAction>("move")
			...
			.def(								constructor<MonsterSpace::EBodyState,MonsterSpace::EMovementType,DetailPathManager::EDetailPathType,const Fvector &, f32>())
			.def(								constructor<const Fvector &, f32>())
			...
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction,Fvector &, f32>())
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction,u32, Fvector &>())
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction,u32, Fvector &, f32>())
			...
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction,Fvector &, f32,	MonsterSpace::EScriptMonsterSpeedParam>())
