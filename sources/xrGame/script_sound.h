...
public:
	...
	IC		void				PlayAtPos			(CScriptGameObject *object, const Fvector &position, f32 delay);
			void				PlayAtPos			(CScriptGameObject *object, const Fvector &position, f32 delay, int flags);
			void				PlayNoFeedback		(CScriptGameObject *object,	u32 flags/*!< Looping */, f32 delay/*!< Delay */, Fvector pos, f32 vol);
	IC		void				Stop				();
