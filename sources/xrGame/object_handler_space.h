...
namespace ObjectHandlerSpace {
	enum EWorldProperties {
		...
		eWorldPropertyNoItems				= u32((unsigned short(-1) << 16) | eWorldPropertyItemID),
		eWorldPropertyNoItemsIdle			= u32((unsigned short(-1) << 16) | eWorldPropertyIdle),
	...
	enum EWorldOperators {
		...
		eWorldOperatorNoItemsIdle	= u32((unsigned short(-1) << 16) | eWorldOperatorIdle),
