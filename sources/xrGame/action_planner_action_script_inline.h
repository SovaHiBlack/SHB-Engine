...
IC	CSActionPlannerActionScript::CActionPlannerActionScript		(const xr_vector<COperatorCondition> &conditions, const xr_vector<COperatorCondition> &effects, _object_type *object, pcstr action_name) :
...
TEMPLATE_SPECIALIZATION
IC	CSActionPlannerActionScript::CActionPlannerActionScript		(_object_type *object, pcstr action_name) :
