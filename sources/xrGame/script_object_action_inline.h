...
IC	CScriptObjectAction::CScriptObjectAction	(pcstr caBoneName, MonsterSpace::EObjectAction tObjectActionType)
{
...
IC	void CScriptObjectAction::SetObject			(pcstr	caBoneName)
{
