...
void CBaseGraviZone::AffectPull(CPHShellHolder* GO, const Fvector3& throw_in_dir, float dist)
{
...
void CBaseGraviZone::AffectPullDead(CPHShellHolder* GO, const Fvector3& throw_in_dir, float dist)
{
	GO->PPhysicsShell( )->applyImpulse(throw_in_dir, dist * m_fThrowInImpulse * GO->GetMass( ) / 100.f);
}

void CBaseGraviZone::AffectThrow(SZoneObjectInfo* O, CPHShellHolder* GO, const Fvector3& throw_in_dir, float dist)
{
