// HitImmunity.cpp:	класс для тех объектов, которые поддерживают коэффициенты иммунитета для разных типов хитов
...
void CHitImmunity::LoadImmunities(const char* imm_sect, CConfigurationFile* ini)
{
