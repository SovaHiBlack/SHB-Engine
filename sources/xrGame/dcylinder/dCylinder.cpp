...
extern "C" s32 dCylBox(const dVector3 p1, const dMatrix3 R1,
					   const dReal radius, const dReal lz, const dVector3 p2,
					   const dMatrix3 R2, const dVector3 side2,
					   dVector3 normal, dReal* depth, s32* code,
					   s32 maxc, dContactGeom* contact, s32 skip)
{
...
extern "C" s32 dCylCyl(const dVector3 p1, const dMatrix3 R1,
...
#pragma todo(optimize factor==0.0f)
//****************************************************************************

s32 dCollideCylS(dxGeom* o1, dxGeom* o2, s32 flags,
				 dContactGeom* contact, s32 skip)
{
	VERIFY(skip >= (s32)sizeof(dContactGeom));
...
s32 dCollideCylB(dxGeom* o1, dxGeom* o2, s32 flags,
				 dContactGeom* contact, s32 skip)
{
	dVector3 normal;
	dReal depth;
	...
	s32 num = dCylBox(dGeomGetPosition(o1), dGeomGetRotation(o1), cylRadius, cylLength,
...
s32 dCollideCylCyl(dxGeom* o1, dxGeom* o2, s32 flags,
				   dContactGeom* contact, s32 skip)
{
	dVector3 normal;
	dReal depth;
	...
	s32 num = dCylCyl(dGeomGetPosition(o1), dGeomGetRotation(o1), cylRadius1, cylLength1,
...
s32 dCollideCylPlane
(
	dxGeom* o1, dxGeom* o2, s32 flags,
	dContactGeom* contact, s32 skip)
{
	VERIFY(skip >= (s32)sizeof(dContactGeom));
	VERIFY(dGeomGetClass(o1) == dCylinderClassUser);
...
s32 dCollideCylRay(dxGeom* o1, dxGeom* o2, s32 flags,
				   dContactGeom* contact, s32 skip)
{
	VERIFY(skip >= (s32)sizeof(dContactGeom));
	VERIFY(dGeomGetClass(o1) == dCylinderClassUser);
...
static  dColliderFn* dCylinderColliderFn(s32 num)
{
