...
CStalkerActionDangerBySoundListenTo::CStalkerActionDangerBySoundListenTo(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerBySoundCheck::CStalkerActionDangerBySoundCheck(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerBySoundTakeCover::CStalkerActionDangerBySoundTakeCover(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerBySoundLookOut::CStalkerActionDangerBySoundLookOut(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerBySoundLookAround::CStalkerActionDangerBySoundLookAround(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
