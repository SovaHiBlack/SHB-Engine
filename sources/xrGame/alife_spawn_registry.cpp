...
CALifeSpawnRegistry::CALifeSpawnRegistry	(pcstr section)
{
	m_spawn_name				= "";
...
void CALifeSpawnRegistry::load(IReader& file_stream, pcstr game_name)
{
...
void CALifeSpawnRegistry::load(pcstr spawn_name)
{
	Msg							("* Loading spawn registry...");
