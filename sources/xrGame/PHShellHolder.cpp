...
void CPHShellHolder::PHSetMaterial(unsigned short m)
{
	if (m_pPhysicsShell)
	{
...
void CPHShellHolder::PHGetLinearVell(Fvector3& velocity)
{
	if (!m_pPhysicsShell)
	{
		velocity.set(0, 0, 0);
...
void CPHShellHolder::PHSetLinearVell(Fvector3& velocity)
{
	if (!m_pPhysicsShell)
	{
		return;
...
unsigned short CPHShellHolder::PHGetSyncItemsNumber( )
{
	if (m_pPhysicsShell)
	{
...
CPHSynchronize* CPHShellHolder::PHGetSyncItem(unsigned short item)
{
	if (m_pPhysicsShell)
	{
