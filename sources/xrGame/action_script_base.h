...
public:
	IC						CActionScriptBase	(const xr_vector<COperatorCondition> &conditions, const xr_vector<COperatorCondition> &effects, _object_type *object = 0, pcstr action_name = "");
	IC						CActionScriptBase	(_object_type *object = 0, pcstr action_name = "");
