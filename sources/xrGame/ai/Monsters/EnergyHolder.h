...
class CEnergyHolder
{
	...
	unsigned int							m_time_last_update;			// время последнего обновления энергии
...
public:
	...
	inline bool		should_deactivate		( )
	{
		return (m_value < m_critical_value);
	}
	inline void		set_auto_activate		(bool b_auto = true)
	{
		m_auto_activate = b_auto;
	}
	inline void		set_auto_deactivate		(bool b_auto = true)
	{
	...
	inline void		set_aggressive			(bool b_val = true)
	{
		m_aggressive = b_val;
	}
