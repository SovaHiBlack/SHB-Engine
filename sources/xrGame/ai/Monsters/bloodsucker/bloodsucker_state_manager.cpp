...
#include "BloodsuckerStateAttack.h"
...
void CStateManagerBloodsucker::execute( )
{
	...
	// Additional
	///////////////////////////////////////////////////////////////////////////////
	if ((prev_substate != eStateHearInterestingSound) && (state_id == eStateHearInterestingSound))	// check if start interesting sound state
	{
		object->predator_start( );
	}
	else if ((prev_substate == eStateHearInterestingSound) && (state_id != eStateHearInterestingSound))	// check if stop interesting sound state
	{
