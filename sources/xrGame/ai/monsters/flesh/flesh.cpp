...
void CFlesh::Load(const char* section)
{
...
bool CFlesh::ConeSphereIntersection(Fvector3 ConeVertex, float ConeAngle, Fvector3 ConeDir, Fvector3 SphereCenter, float SphereRadius)
{
