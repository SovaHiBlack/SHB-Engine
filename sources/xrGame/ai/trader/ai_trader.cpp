...
void CTrader::Load(const char* section)
{
	//	setEnabled						(FALSE);
...
void CTrader::reload	(const char* section)
{
...
void CTrader::g_WeaponBones	(int &L, int &R1, int &R2)
{
...
void CTrader::dialog_sound_start(const char* phrase)
{
