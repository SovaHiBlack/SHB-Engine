...
IC	CScriptBaseAction::CActionScriptBase		(const xr_vector<COperatorCondition> &conditions, const xr_vector<COperatorCondition> &effects, _object_type *object, pcstr action_name) :
...
TEMPLATE_SPECIALIZATION
IC	CScriptBaseAction::CActionScriptBase		(_object_type *object, pcstr action_name) :
