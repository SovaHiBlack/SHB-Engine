...
public:
	IC					CActionPlannerAction	(_object_type *object = 0, pcstr action_name = "");
	...
	virtual	void		save					(CNetPacket& packet) {inherited_planner::save(packet); inherited_action::save(packet);}
