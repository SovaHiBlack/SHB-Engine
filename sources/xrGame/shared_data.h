...
public:
	...
	{
		pSharedObj = CSharedObj<SHARED_TYPE, KEY_TYPE>::Instance( ); pSharedObj->_on_self_delete = auto_delete;
	}
	...
	void			load_shared(KEY_TYPE key, pcstr section)
	{
	...
	virtual void	load_shared(pcstr section)
	{ }
