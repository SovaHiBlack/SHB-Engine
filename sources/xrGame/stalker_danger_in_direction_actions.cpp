...
CStalkerActionDangerInDirectionTakeCover::CStalkerActionDangerInDirectionTakeCover(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerInDirectionLookOut::CStalkerActionDangerInDirectionLookOut(CStalker* object, pcstr action_name) : inherited(object, action_name)
{
...
CStalkerActionDangerInDirectionHoldPosition::CStalkerActionDangerInDirectionHoldPosition(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerInDirectionDetour::CStalkerActionDangerInDirectionDetour(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionDangerInDirectionSearch::CStalkerActionDangerInDirectionSearch(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
