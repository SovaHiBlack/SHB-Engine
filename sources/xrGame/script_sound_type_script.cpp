	...
	[
		class_<enum_exporter<ESoundTypes> >("snd_type")
			...
			[
				...
				value("weapon_shoot",			s32(eST_WEAPON_SHOOTING)),
				value("weapon_empty",			s32(eST_WEAPON_EMPTY_CLICKING)),
				value("weapon_bullet_hit",		s32(eST_WEAPON_BULLET_HIT)),
				value("weapon_reload",			s32(eST_WEAPON_RECHARGING)),
				value("monster_die",			s32(eST_MONSTER_DYING)),
				value("monster_injure",			s32(eST_MONSTER_INJURING)),
				value("monster_step",			s32(eST_MONSTER_STEP)),
				value("monster_talk",			s32(eST_MONSTER_TALKING)),
				value("monster_attack",			s32(eST_MONSTER_ATTACKING)),
				value("monster_eat",			s32(eST_MONSTER_EATING)),
				value("anomaly_idle",			s32(eST_ANOMALY_IDLE)),
				value("world_object_break",		s32(eST_WORLD_OBJECT_BREAKING)),
				value("world_object_collide",	s32(eST_WORLD_OBJECT_COLLIDING)),
				value("world_object_explode",	s32(eST_WORLD_OBJECT_EXPLODING)),
				value("world_ambient",			s32(eST_WORLD_AMBIENT))
			]
	];
}
