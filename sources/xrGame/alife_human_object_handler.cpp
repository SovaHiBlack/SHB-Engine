...
s32 CALifeHumanObjectHandler::choose_equipment(ALife::OBJECT_VECTOR* objects)
{
	return	(-1);
}

s32 CALifeHumanObjectHandler::choose_weapon(const ALife::EWeaponPriorityType& weapon_priority_type, ALife::OBJECT_VECTOR* objects)
{
	return	(-1);
}

s32 CALifeHumanObjectHandler::choose_food(ALife::OBJECT_VECTOR* objects)
{
	return	(-1);
}

s32 CALifeHumanObjectHandler::choose_medikit(ALife::OBJECT_VECTOR* objects)
{
	return	(-1);
}

s32 CALifeHumanObjectHandler::choose_detector(ALife::OBJECT_VECTOR* objects)
{
	return	(-1);
}

s32 CALifeHumanObjectHandler::choose_valuables( )
{
	return	(-1);
}
