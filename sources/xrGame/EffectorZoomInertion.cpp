...
void CEffectorZoomInertion::Load( )
{
	...
	m_vTargetVel.set(0.0f, 0.0f, 0.0f);
	m_vCurrentPoint.set(0.0f, 0.0f, 0.0f);
	m_vTargetPoint.set(0.0f, 0.0f, 0.0f);
	m_vLastPoint.set(0.0f, 0.0f, 0.0f);
}
...
void CEffectorZoomInertion::CalcNextPoint( )
{
	...
	f32 half_disp_radius = m_fDispRadius / 2.0f;
...
BOOL CEffectorZoomInertion::Process(fVector3& p, fVector3& d, fVector3& n, f32& fFov, f32& fFar, f32& fAspect)
{
