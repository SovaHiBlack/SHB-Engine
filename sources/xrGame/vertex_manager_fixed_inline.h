...
TEMPLATE_SPECIALIZATION
inline	typename CFixedVertexManager::CGraphVertex &CFixedVertexManager::create_vertex	(CGraphVertex &vertex, const _index_type &vertex_id)
{
	VERIFY							(vertex_id < m_max_node_count);
...
TEMPLATE_SPECIALIZATION
inline	typename CFixedVertexManager::_path_id_type CFixedVertexManager::current_path_id	() const
{
