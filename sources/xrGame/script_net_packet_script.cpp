...
//			.def("r",				&CNetPacket::r				)
			...
			.def("r_u64",			(void (CNetPacket::*)(unsigned __int64&	))(&CNetPacket::r_u64		))
			.def("r_s64",			(void (CNetPacket::*)(signed __int64&	))(&CNetPacket::r_s64		))
			...
			.def("r_u64",			(unsigned __int64(CNetPacket::*)()	)(&CNetPacket::r_u64		))
			.def("r_s64",			(signed __int64(CNetPacket::*)()	)(&CNetPacket::r_s64		))
