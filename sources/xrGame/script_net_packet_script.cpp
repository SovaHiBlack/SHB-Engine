...
CClientID r_clientID(NET_Packet *self)
{
	CClientID		clientID;
...
//			.def("r",				&NET_Packet::r				)
			...
			.def("r_float",			(void (NET_Packet::*)(f32&))(&NET_Packet::r_float		))
			...
			.def("r_bool",			&r_bool						)
			.def("r_float",			(f32(NET_Packet::*)()	)(&NET_Packet::r_float		))
			...
			.def("r_float_q16",		(void	(NET_Packet::*)(f32&, f32, f32)	)(&NET_Packet::r_float_q16)	)
			.def("r_float_q8",		(void	(NET_Packet::*)(f32&, f32, f32)	)(&NET_Packet::r_float_q8)	)
