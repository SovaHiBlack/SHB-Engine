...
bool CStalker::can_sell(const CInventoryItem* item)
{
	update_sell_info( );
...
bool CStalker::AllowItemToTrade(const CInventoryItem* item, EItemPlace place) const
{
	if (!g_Alive( ))
...
bool CStalker::can_take(const CInventoryItem* item)
{
