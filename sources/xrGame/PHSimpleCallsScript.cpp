...
void CPHCallOnStepCondition::script_register(lua_State *L)
{
	module(L)
		[
			...
			.def("set_global_time_s",		(void(CPHCallOnStepCondition::*)(f32))(&CPHCallOnStepCondition::set_global_time))
			.def("set_time_interval_ms",	(void(CPHCallOnStepCondition::*)(u32))(&CPHCallOnStepCondition::set_time_interval))
			.def("set_time_interval_s",		(void(CPHCallOnStepCondition::*)(f32))(&CPHCallOnStepCondition::set_time_interval))
			.def(constructor<>())
		];
}
