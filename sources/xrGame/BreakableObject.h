// BreakableObject.h: interface for the CBreakableObject class.
...
private:
	...
	static unsigned int							m_remove_time;
	unsigned int								m_break_time;
	bool										bRemoved;
...
public:
	...
	virtual void	shedule_Update				(unsigned int dt);				// Called by sheduler
