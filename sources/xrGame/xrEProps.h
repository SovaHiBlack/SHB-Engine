...
public:
	...
	virtual S16Value* 			__stdcall	CreateS16		    (PropItemsVec& items, CSharedString key, signed short* val, signed short mn=0, signed short mx=100, signed short inc=1)=0;
	...
	virtual U16Value* 			__stdcall	CreateU16		    (PropItemsVec& items, CSharedString key, unsigned short* val, unsigned short mn=0, unsigned short mx=100, unsigned short inc=1)=0;
	...
	virtual Flag16Value*		__stdcall	CreateFlag16	    (PropItemsVec& items, CSharedString key, Flags16* val, unsigned short mask, const char* c0=0, const char* c1=0, u32 flags=0)=0;
	...
	virtual Token16Value*		__stdcall	CreateToken16	    (PropItemsVec& items, CSharedString key, unsigned short* val, xr_token* token)=0;
	...
	virtual RToken16Value* 		__stdcall	CreateRToken16	    (PropItemsVec& items, CSharedString key, unsigned short* val, xr_rtoken* token, u32 t_cnt)=0;
