...
public:
	...
	virtual 	void 			InitContact(dContact* c, bool& do_collide, unsigned short /*material_idx_1*/, unsigned short /*material_idx_2*/) = 0;
	...
	virtual		unsigned short				get_elements_number( ) = 0;
	virtual		CPHSynchronize* get_element_sync(unsigned short element) = 0;
