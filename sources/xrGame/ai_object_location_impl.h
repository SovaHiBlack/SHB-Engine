...
inline	void CAI_ObjectLocation::game_vertex(const CGameGraph::CVertex *game_vertex)
{
...
inline	void CAI_ObjectLocation::game_vertex(const GameGraph::_GRAPH_ID	game_vertex_id)
{
...
inline	void CAI_ObjectLocation::level_vertex(const CLevelGraph::CVertex *level_vertex)
{
...
inline	void CAI_ObjectLocation::level_vertex(const u32 level_vertex_id)
{
	VERIFY				(ai().level_graph().valid_vertex_id(level_vertex_id));
	m_level_vertex_id	= level_vertex_id;
}

inline	const CLevelGraph::CVertex *CAI_ObjectLocation::level_vertex() const
{
