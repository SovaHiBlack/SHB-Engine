...
float STestCallbackPars::callback_force_factor = 10.0f;
float STestCallbackPars::depth_to_change_softness_pars = 0.0f;
float STestCallbackPars::callback_cfm_factor = world_cfm * 0.00001f;
float STestCallbackPars::callback_erp_factor = 1.0f;
float STestCallbackPars::decrement_depth = 0.0f;
...
float STestFootCallbackPars::callback_force_factor = 10.0f;
float STestFootCallbackPars::depth_to_change_softness_pars = 0.0f;
float STestFootCallbackPars::callback_cfm_factor = world_cfm * 0.00001f;
float STestFootCallbackPars::callback_erp_factor = 1.0f;
...
public:
	...
	bool VelocityLimit( )
	{
		...
		{
			dReal mag;
			Fvector3 vlinear_velocity; vlinear_velocity.set(cast_fv(linear_velocity));
