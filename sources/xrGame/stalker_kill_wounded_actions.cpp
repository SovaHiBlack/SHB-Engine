...
CStalkerActionReachWounded::CStalkerActionReachWounded(CStalker* object, pcstr action_name) :
...
CStalkerActionAimWounded::CStalkerActionAimWounded(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionPrepareWounded::CStalkerActionPrepareWounded(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
