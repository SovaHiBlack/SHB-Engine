...
CStalkerActionLookOut::CStalkerActionLookOut(CStalker* object, pcstr action_name) : inherited(object, action_name)
{
...
CStalkerActionHoldPosition::CStalkerActionHoldPosition(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionSearchEnemy::CStalkerActionSearchEnemy(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionPostCombatWait::CStalkerActionPostCombatWait(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionGetDistance::CStalkerActionGetDistance(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionHideFromGrenade::CStalkerActionHideFromGrenade(CStalker* object, pcstr action_name) :	inherited(object, action_name)
{ }
...
CStalkerActionSuddenAttack::CStalkerActionSuddenAttack(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionKillEnemyIfPlayerOnThePath::CStalkerActionKillEnemyIfPlayerOnThePath(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
...
CStalkerActionCriticalHit::CStalkerActionCriticalHit(CStalker* object, pcstr action_name) : inherited(object, action_name)
{ }
