...
CStalkerActionGetItemToKill::CStalkerActionGetItemToKill	(CAI_Stalker *object, pcstr action_name) :
...
CStalkerActionMakeItemKilling::CStalkerActionMakeItemKilling	(CAI_Stalker *object, pcstr action_name) :
	inherited				(object,action_name)
{ }
...
CStalkerActionRetreatFromEnemy::CStalkerActionRetreatFromEnemy	(CAI_Stalker *object, pcstr action_name) :
	inherited				(object,action_name)
{ }
...
CStalkerActionGetReadyToKill::CStalkerActionGetReadyToKill(bool affect_properties, CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{
...
CStalkerActionKillEnemy::CStalkerActionKillEnemy(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
...
CStalkerActionTakeCover::CStalkerActionTakeCover(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
...
CStalkerActionLookOut::CStalkerActionLookOut(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{
...
CStalkerActionHoldPosition::CStalkerActionHoldPosition(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
...
CStalkerActionDetourEnemy::CStalkerActionDetourEnemy(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
...
CStalkerActionSearchEnemy::CStalkerActionSearchEnemy(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
...
CStalkerActionPostCombatWait::CStalkerActionPostCombatWait	(CAI_Stalker *object, pcstr action_name) :
	inherited				(object, action_name)
{ }
...
CStalkerActionGetDistance::CStalkerActionGetDistance	(CAI_Stalker *object, pcstr action_name) :
	inherited				(object, action_name)
{ }
...
CStalkerActionHideFromGrenade::CStalkerActionHideFromGrenade	(CAI_Stalker *object, pcstr action_name) :
	inherited				(object, action_name)
{ }
...
CStalkerActionSuddenAttack::CStalkerActionSuddenAttack		(CAI_Stalker *object, pcstr action_name) :
	inherited				(object, action_name)
{ }
...
CStalkerActionKillEnemyIfPlayerOnThePath::CStalkerActionKillEnemyIfPlayerOnThePath(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
...
CStalkerActionCriticalHit::CStalkerActionCriticalHit		(CAI_Stalker *object, pcstr action_name) :
	inherited(object,action_name)
{ }
