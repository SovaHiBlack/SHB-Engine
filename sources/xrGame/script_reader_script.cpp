...
void CScriptReader::script_register(lua_State *L)
{
	...
	[
		class_<IReader>("reader")
			...
			.def("r_u64",			(void (IReader::*)(unsigned __int64&	))(&IReader::r_u64		))
			.def("r_s64",			(void (IReader::*)(signed __int64&	))(&IReader::r_s64		))
			...
			.def("r_u64",			(unsigned __int64(IReader::*)()	)(&IReader::r_u64		))
			.def("r_s64",			(signed __int64(IReader::*)()	)(&IReader::r_s64		))
