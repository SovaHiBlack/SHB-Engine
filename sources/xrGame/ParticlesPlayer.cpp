...
void CParticlesPlayer::LoadParticles(CKinematics* K)
{
	...
	//считать список косточек и соответствующих офсетов куда можно вешать партиклы
...
void CParticlesPlayer::StartParticles(const shared_str& particles_name, u16 bone_num, const fVector3& dir, u16 sender_id, s32 life_time, bool auto_stop)
{
	fMatrix4x4 xform;
...
void CParticlesPlayer::StartParticles(const shared_str& particles_name, u16 bone_num, const fMatrix4x4& xform, u16 sender_id, s32 life_time, bool auto_stop)
{
...
void CParticlesPlayer::StartParticles(const shared_str& ps_name, const fMatrix4x4& xform, u16 sender_id, s32 life_time, bool auto_stop)
{
	CObject* object = m_self_object;
	VERIFY(object);
...
void CParticlesPlayer::StartParticles(const shared_str& ps_name, const fVector3& dir, u16 sender_id, s32 life_time, bool auto_stop)
{
	fMatrix4x4 xform;
	generate_orthonormal_basis(dir, xform);
