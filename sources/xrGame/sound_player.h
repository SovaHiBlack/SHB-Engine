...
public:
	...
	struct CSoundCollection : public CRandom32 {
		...
		u32										m_last_sound_id;
							...
							~CSoundCollection	();
		IC	ref_sound		*add				(ESoundTypes type, pcstr name) const;
...
public:
	...
	virtual	void		reload						(pcstr section);
			void		unload						();
			u32			add							(pcstr prefix, u32 max_count, ESoundTypes type, u32 priority, u32 mask, u32 internal_type, pcstr bone_name, CSound_UserDataPtr data = 0);
