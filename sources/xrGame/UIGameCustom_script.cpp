...
void CUIGameCustom::script_register(lua_State *L)
{
	module(L)
		[
			...
			.def("AddCustomMessage",		(void(CUIGameCustom::*)(pcstr, float, float, float, CGameFont*, u16, u32/*, pcstr*/))&CUIGameCustom::AddCustomMessage)
			.def("AddCustomMessage",		(void(CUIGameCustom::*)(pcstr, float, float, float, CGameFont*, u16, u32/*, pcstr*/, float))&CUIGameCustom::AddCustomMessage)
