...
void add_actor_points(pcstr sect, pcstr detail_key, int cnt, int pts)
{
...
int get_actor_points(pcstr sect)
{
...
void add_pp_effector(pcstr fn, int id, bool cyclic)
{
...
#include "relation_registry.h"
 ...
 int g_community_goodwill(pcstr _community, int _entity_id)
 {
...
void g_set_community_goodwill(pcstr _community, int _entity_id, int val)
{
	 CHARACTER_COMMUNITY	c;
	 c.set					(_community);
...
void g_change_community_goodwill(pcstr _community, int _entity_id, int val)
{
	 CHARACTER_COMMUNITY	c;
	 c.set					(_community);
