...
IC	CScriptParticleAction::CScriptParticleAction	(pcstr caPartcileToRun, pcstr caBoneName, const CParticleParams &tParticleParams, bool bAutoRemove)
{
	SetBone				(caBoneName);
...
IC	CScriptParticleAction::CScriptParticleAction	(pcstr caPartcileToRun, const CParticleParams &tParticleParams, bool bAutoRemove)
{
	SetParticle			(caPartcileToRun,bAutoRemove);
	SetPosition			(tParticleParams.m_tParticlePosition);
	SetAngles			(tParticleParams.m_tParticleAngles);
...
IC	void CScriptParticleAction::SetBone				(pcstr caBoneName)
{
