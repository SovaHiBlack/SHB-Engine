...
void get_matrix_hpb(Fmatrix* self, f32* h, f32* p, f32* b)
{
	self->getHPB	(*h, *p, *b);
}
...
void CScriptFmatrix::script_register(lua_State *L)
{
	...
	[
		class_<Fmatrix>("matrix")
			...
			.def("mul",							(Fmatrix & (Fmatrix::*)(const Fmatrix &, f32))(&Fmatrix::mul),															return_reference_to(_1))
			.def("mul",							(Fmatrix & (Fmatrix::*)(f32))(&Fmatrix::mul),																			return_reference_to(_1))
			.def("div",							(Fmatrix & (Fmatrix::*)(const Fmatrix &, f32))(&Fmatrix::div),															return_reference_to(_1))
			.def("div",							(Fmatrix & (Fmatrix::*)(f32))(&Fmatrix::div),																			return_reference_to(_1))
...
//			.def("translate",					(Fmatrix & (Fmatrix::*)(f32, f32, f32))(&Fmatrix::translate),														return_reference_to(_1))
//			.def("translate_over",				(Fmatrix & (Fmatrix::*)(const Fvector &))(&Fmatrix::translate_over),														return_reference_to(_1))
//			.def("translate_over",				(Fmatrix & (Fmatrix::*)(f32, f32, f32))(&Fmatrix::translate_over),													return_reference_to(_1))
...
//			.def("scale",						(Fmatrix & (Fmatrix::*)(f32, f32, f32))(&Fmatrix::scale),															return_reference_to(_1))
...
//			.def("rotation",					(Fmatrix & (Fmatrix::*)(const Fvector &, f32))(&Fmatrix::rotation),													return_reference_to(_1))
...
//			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(Fvector &))(&Fmatrix::setXYZ),																	return_reference_to(_1)	+	out_value(_2))
			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(f32, f32, f32))(&Fmatrix::setXYZ),															return_reference_to(_1))
//			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(Fvector &))(&Fmatrix::setXYZi),																	return_reference_to(_1) +	out_value(_2))
			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(f32, f32, f32))(&Fmatrix::setXYZi),														return_reference_to(_1))
...
//			.def("getXYZ",						(void	   (Fmatrix::*)(f32 &, f32 &, f32 &) const)(&Fmatrix::getXYZ))
//			.def("getXYZi",						(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::getXYZi),																						out_value(_2))
//			.def("getXYZi",						(void	   (Fmatrix::*)(f32 &, f32 &, f32 &) const)(&Fmatrix::getXYZi))
	];
}
