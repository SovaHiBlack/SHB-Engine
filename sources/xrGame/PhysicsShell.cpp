	...
	module(L)
		[
			class_<CPhysicsJoint>("physics_joint")
				...
				.def("set_axis_dir_global", (void(CPhysicsJoint::*)(const f32, const f32, const f32, const s32))(&CPhysicsJoint::SetAxisDir))
				.def("set_axis_dir_vs_first_element", (void(CPhysicsJoint::*)(const f32, const f32, const f32, const s32))(&CPhysicsJoint::SetAxisDirVsFirstElement))
				.def("set_axis_dir_vs_second_element", (void(CPhysicsJoint::*)(const f32, const f32, const f32, const s32))(&CPhysicsJoint::SetAxisDirVsSecondElement))
