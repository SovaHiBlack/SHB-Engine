...
void CSE_ALifeItem::OnEvent					(NET_Packet &tNetPacket, u16 type, u32 time, CClientID sender )
{
...
void CSE_ALifeItemWeapon::OnEvent			(NET_Packet	&tNetPacket, u16 type, u32 time, CClientID sender )
{
