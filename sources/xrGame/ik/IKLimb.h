...
IC				f32		CollideFoot			(f32 angle, const fMatrix4x4& gl_anim, fPlane3& p, Fvector &ax );
IC				void		make_shift			(fMatrix4x4& xm, const fPlane3& p,const Fvector &pick_dir );
...
IC				void		AnimGoal			(fMatrix4x4& gl, CKinematicsAnimated	&K );
				...
				void		GetPickDir			(Fvector &v, const fMatrix4x4& gl_bone ) ;
