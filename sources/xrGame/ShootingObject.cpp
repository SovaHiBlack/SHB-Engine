// ShootingObject.cpp:  интерфейс для семейства стреляющих объектов (оружие и осколочные гранаты)
...
void CShootingObject::LoadFireParams(const char* section, const char* prefix)
{
	string256	full_name;
	string32	buffer;
