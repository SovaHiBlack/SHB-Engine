...
IC	CEvaluator::CPropertyEvaluator	(_object_type *object, pcstr evaluator_name)
{
...
TEMPLATE_SPECIALIZATION
IC	void CEvaluator::init			(_object_type *object, pcstr evaluator_name)
{
	m_object			= object;
#ifdef LOG_ACTION
...
TEMPLATE_SPECIALIZATION
void CEvaluator::Load				(pcstr section)
{
}
