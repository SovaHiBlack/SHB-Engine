...
public:
	CFunctionGraph( );
	~CFunctionGraph( );
	void	Init(type_function fun, f32 x0, f32 x1, s32 l, s32 t, s32 w, s32 h, s32 points_num = 500, u32 color = D3DCOLOR_XRGB(0, 255, 0), u32 bk_color = D3DCOLOR_XRGB(255, 255, 255));
	void	Clear( );
	bool	IsActive( );
