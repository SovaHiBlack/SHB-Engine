...
CObjectActionCommand::CObjectActionCommand(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, u32 command, const char* action_name) :
...
CObjectActionShow::CObjectActionShow	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
...
CObjectActionHide::CObjectActionHide	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
}
...
CObjectActionReload::CObjectActionReload	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, _condition_type type, const char* action_name) :
	inherited		(item,owner,storage,action_name),
	m_type			(type)
{
}
...
CObjectActionFire::CObjectActionFire	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, _condition_type type, const char* action_name) :
	inherited		(item,owner,storage,action_name),
	m_type			(type)
{
}
...
CObjectActionStrapping::CObjectActionStrapping	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
...
CObjectActionStrappingToIdle::CObjectActionStrappingToIdle	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
	m_callback_removed			= true;
}
...
CObjectActionUnstrapping::CObjectActionUnstrapping	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
	m_callback_removed			= true;
}
...
CObjectActionUnstrappingToIdle::CObjectActionUnstrappingToIdle	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
	m_callback_removed			= true;
}
...
CObjectActionQueueWait::CObjectActionQueueWait	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, _condition_type type, const char* action_name) :
	inherited				(item,owner,storage,action_name),
	m_type					(type)
{
...
CObjectActionSwitch::CObjectActionSwitch	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, _condition_type type, const char* action_name) :
	inherited		(item,owner,storage,action_name),
	m_type			(type)
{
}
...
CObjectActionDrop::CObjectActionDrop	(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited		(item,owner,storage,action_name)
{
}
...
void CObjectActionDrop::initialize		()
{
	...
	P.w_u16					(unsigned short(m_item->object().ID()));
...
CObjectActionThreaten::CObjectActionThreaten	(CStalker *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited				(item,owner,storage,action_name)
{
}
...
CObjectActionAim::CObjectActionAim			(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, _condition_type condition_id, _value_type value, const char* action_name) :
...
CObjectActionIdle::CObjectActionIdle(CInventoryItem *item, CStalker *owner, CPropertyStorage *storage, const char* action_name) :
	inherited			(item,owner,storage,action_name)
{
}
