...
CObjectActionHide::CObjectActionHide(CInventoryItem* item, CStalker* owner, CPropertyStorage* storage, pcstr action_name) :
	inherited(item, owner, storage, action_name)
{ }
...
CObjectActionReload::CObjectActionReload(CInventoryItem* item, CStalker* owner, CPropertyStorage* storage, _condition_type type, pcstr action_name) :
	inherited(item, owner, storage, action_name),
	m_type(type)
{ }
