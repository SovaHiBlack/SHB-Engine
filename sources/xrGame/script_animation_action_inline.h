...
IC	CScriptAnimationAction::CScriptAnimationAction	(pcstr caAnimationToPlay, bool use_animation_movement_controller)
{
...
IC	void CScriptAnimationAction::SetAnimation		(pcstr caAnimationToPlay)
{
