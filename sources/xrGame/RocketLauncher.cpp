// RocketLauncher.cpp:	интерфейс дл€ семейства объектов стрел€ющих гранатами и ракетами
...
void CRocketLauncher::SpawnRocket(const char* rocket_section, CGameObject* parent_rocket_launcher)
{
