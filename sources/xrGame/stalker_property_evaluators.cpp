...
CStalkerPropertyEvaluatorALife::CStalkerPropertyEvaluatorALife(CStalker* object, pcstr evaluator_name) :
...
CStalkerPropertyEvaluatorAlive::CStalkerPropertyEvaluatorAlive(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorItems::CStalkerPropertyEvaluatorItems(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorSeeEnemy::CStalkerPropertyEvaluatorSeeEnemy(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorEnemySeeMe::CStalkerPropertyEvaluatorEnemySeeMe(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorItemToKill::CStalkerPropertyEvaluatorItemToKill(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorItemCanKill::CStalkerPropertyEvaluatorItemCanKill(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorFoundItemToKill::CStalkerPropertyEvaluatorFoundItemToKill(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorFoundAmmo::CStalkerPropertyEvaluatorFoundAmmo(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorReadyToKill::CStalkerPropertyEvaluatorReadyToKill(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorReadyToDetour::CStalkerPropertyEvaluatorReadyToDetour(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorAnomaly::CStalkerPropertyEvaluatorAnomaly(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorInsideAnomaly::CStalkerPropertyEvaluatorInsideAnomaly(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorPanic::CStalkerPropertyEvaluatorPanic(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorSmartTerrainTask::CStalkerPropertyEvaluatorSmartTerrainTask(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorEnemyReached::CStalkerPropertyEvaluatorEnemyReached(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorPlayerOnThePath::CStalkerPropertyEvaluatorPlayerOnThePath(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
...
CStalkerPropertyEvaluatorEnemyCriticallyWounded::CStalkerPropertyEvaluatorEnemyCriticallyWounded(CStalker* object, pcstr evaluator_name) :
	inherited(object ? object->lua_game_object( ) : 0, evaluator_name)
{ }
