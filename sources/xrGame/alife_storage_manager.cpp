...
void CALifeStorageManager::save(pcstr save_name, bool update_name)
{
	...
	pvoid dest_data;
	{
		...
		pvoid source_data = stream.pointer( );
...
void CALifeStorageManager::load(pvoid buffer, const u32& buffer_size, pcstr file_name)
{
...
bool CALifeStorageManager::load(pcstr save_name)
{
	...
	pvoid source_data = xr_malloc(source_count);
