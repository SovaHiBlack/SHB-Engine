...
void CScriptSoundAction::script_register(lua_State *L)
{
	...
	[
		class_<CScriptSoundAction>("sound")
			...
			.def(								constructor<const char*,const Fvector &>())
			.def(								constructor<const char*,const Fvector &,const Fvector &>())
			.def(								constructor<const char*,const Fvector &,const Fvector &,bool>())
