...
inline bool  TriPlaneContainPoint(const dReal* v0,const dReal* v1,const dReal* v2, const dReal* pos){
 ...
 __forceinline	void InitTriangle(CDB::TRI* XTri,Triangle& triangle,const Fvector3*	 V_array)
 {
 ...
 __forceinline	void CalculateTri(CDB::TRI* XTri,const float* pos,Triangle& triangle,const Fvector3* V_array)
 {
