...
public:
						CStalkerActionGetItemToKill	(CStalker *object, const char* action_name = "");
...
public:
						CStalkerActionMakeItemKilling	(CStalker *object, const char* action_name = "");
	virtual void		initialize						();
	virtual void		execute							();
	virtual void		finalize						();
};
...
public:
						CStalkerActionRetreatFromEnemy	(CStalker *object, const char* action_name = "");
	virtual void		initialize						();
	virtual void		execute							();
	virtual void		finalize						();
...
public:
						CStalkerActionGetReadyToKill(bool affect_properties, CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionKillEnemy		(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionTakeCover		(CStalker *object, const char* action_name = "");
	virtual void		initialize						();
	virtual void		execute							();
	virtual void		finalize						();
};
...
public:
						CStalkerActionLookOut		(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionHoldPosition	(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionGetDistance	(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionDetourEnemy	(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionSearchEnemy	(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionPostCombatWait(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionHideFromGrenade(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionSuddenAttack	(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CStalkerActionKillEnemyIfPlayerOnThePath(CStalker *object, const char* action_name = "");
	virtual void		initialize								();
	virtual void		execute									();
	virtual void		finalize								();
};
...
public:
						CStalkerActionCriticalHit	(CStalker *object, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
