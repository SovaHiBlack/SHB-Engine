...
namespace object_comparer
{
	namespace detail
	{
		...
		{
			template <typename T>
			inline	bool operator() (const T& _1, const T& _2)	const
			{
				return(P<T>( )		(_1, _2));
			}
			...
			inline	bool operator() (char* _1, char* _2)		const
			{
				return(P<int>( )	(xr_strcmp(_1, _2), 0));
			}
			inline	bool operator() (const char* _1, char* _2)		const
			{
				return(P<int>( )	(xr_strcmp(_1, _2), 0));
			}
			inline	bool operator() (char* _1, const char* _2)		const
			{
				return(P<int>( )	(xr_strcmp(_1, _2), 0));
			}
		};
