...
IC	CSObjectItemSingle::CObjectItemSingle	(const CLASS_ID &clsid, pcstr script_clsid) :
...
TEMPLATE_SPECIALIZATION
ObjectFactory::SERVER_BASE_CLASS *CSObjectItemSingle::server_object	(pcstr section) const
{
...
IC	CObjectItemSingle<_unknown_type,true>::CObjectItemSingle	(const CLASS_ID &clsid, pcstr script_clsid) :
	inherited			(clsid,script_clsid)
{
}
...
template <typename _unknown_type>
ObjectFactory::SERVER_BASE_CLASS *CObjectItemSingle<_unknown_type,true>::server_object	(pcstr section) const
{
