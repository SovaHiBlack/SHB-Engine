...
public:
	...
	virtual void				show				(pcstr offset = "");
#endif

public:
	IC							CActionBase			(const xr_vector<COperatorCondition> &conditions, const xr_vector<COperatorCondition> &effects, _object_type *object = 0, pcstr action_name = "");
	IC							CActionBase			(_object_type *object, pcstr action_name = "");
	virtual						~CActionBase		();
	IC		void				init				(_object_type *object, pcstr action_name);
