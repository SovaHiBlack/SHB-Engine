...
public:
	...
	{
		m_b_enabled = b; if (!m_b_enabled)Show(m_b_enabled);
	}
	bool	GetEnabled( )
	{
		return m_b_enabled;
	...
	{
		m_iPageSize = _max(0, iPage); UpdateScrollBar( );
	}
	int				GetPageSize( )
	{
		return m_iPageSize;
	...
	{
		SetScrollPosClamped(iPos); UpdateScrollBar( );
	}
	int				GetScrollPos( )
	{
