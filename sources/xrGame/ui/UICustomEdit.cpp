...
void CUICustomEdit::SendMessage(CUIWindow* pWnd, s16 msg, pvoid pData)
{
...
bool CUICustomEdit::OnKeyboard(s32 dik, EUIMessages keyboard_action)
{
	if (!m_bInputFocus)
	{
		return false;
...
bool CUICustomEdit::KeyReleased(s32 dik)
{
	switch (dik)
	{
		case DIK_LSHIFT:
