...
CUIColorAnimatorWrapper::CUIColorAnimatorWrapper( ) : colorAnimation(NULL), animationTime(0.0f), color(NULL), isDone(false), reverse(false), kRev(0.0f)
{
	prevGlobalTime = Device.dwTimeContinual / 1000.0f;
	currColor = 0xffff0000;
}

CUIColorAnimatorWrapper::CUIColorAnimatorWrapper(u32* colorToModify) : colorAnimation(NULL), animationTime(0.0f), color(NULL), isDone(false), reverse(false), kRev(0.0f)
{
	prevGlobalTime = Device.dwTimeContinual / 1000.0f;
	color = colorToModify;
	currColor = 0xffff0000;
