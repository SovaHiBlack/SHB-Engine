...
int GetARGB(unsigned short a, unsigned short r, unsigned short g, unsigned short b)
{
...
void CUIWindow::script_register(lua_State *L)
{
	...
	[
		...
		.def("Init",						(void (CUIFrameWindow::*)(const char*, float, float, float, float))	&CUIFrameWindow::Init),
		...
		.def("Init",						(void (CUIFrameLineWnd::*)(const char*, float, float, float, float, bool))	&CUIFrameLineWnd::Init),
