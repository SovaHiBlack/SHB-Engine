...
{
private:
	using inherited = WORLD_OPERATOR;
...
{
private:
	using inherited = CSomeMapAction;
...
{
private:
	using inherited = CMapActionZoomControl;
...
{
private:
	using inherited = CPropertyEvaluator<CUIMapWnd>;
...
{
private:
	using inherited = CSomeMapEvaluator;
...
public:
	CEvaluatorMapConst(bool val = false, const char* evaluator_name = 0) : inherited(evaluator_name)
	{
		ret_value = val;
	};
	virtual bool	evaluate( )
...
const char* CMapActionPlanner::object_name( ) const
{
	return ("");
}
