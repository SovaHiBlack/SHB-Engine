...
public:
	...
	void	SetTextColor_script(s32 a, s32 r, s32 g, s32 b)
	{
	...
	virtual void SetTextX(f32 text_x)
	{
		m_TextOffset.x = text_x;
	}
	virtual void SetTextY(f32 text_y)
	{
		m_TextOffset.y = text_y;
	}
	virtual void SetTextPos(f32 x, f32 y)
	{
		SetTextX(x);
		SetTextY(y);
	}
	...
	void SetElipsis(EElipsisPosition pos, s32 indent);

	void	SetHeading(f32 f)
	{
		m_fHeading = f;
	};
	f32	GetHeading( )
