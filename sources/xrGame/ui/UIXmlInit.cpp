...
bool CUIXmlInit::InitWindow(CUIXml& xml_doc, pcstr path, int index, CUIWindow* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitFrameWindow(CUIXml& xml_doc, pcstr path, int index, CUIFrameWindow* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
/*
	...
	f32 x = xml_doc.ReadAttribFlt(buf, index, "x");
	f32 y = xml_doc.ReadAttribFlt(buf, index, "y");
...
bool CUIXmlInit::InitOptionsItem(CUIXml& xml_doc, pcstr paht, int index, CUIOptionsItem* pWnd){
	string256 buf;
...
bool CUIXmlInit::InitStatic(CUIXml& xml_doc, pcstr path, int index, CUIStatic* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitCheck(CUIXml& xml_doc, pcstr path, int index, CUICheckButton* pWnd){
...
bool CUIXmlInit::InitSpin(CUIXml& xml_doc, pcstr path, int index, CUICustomSpin* pWnd){
	InitWindow(xml_doc, path, index, pWnd);
	InitOptionsItem(xml_doc, path, index, pWnd);
...
bool CUIXmlInit::InitText(CUIXml& xml_doc, pcstr path, int index, CUIStatic* pWnd){
...
bool CUIXmlInit::InitText(CUIXml& xml_doc, pcstr path, int index, IUITextControl* pWnd){
	u32 color;
...
bool CUIXmlInit::Init3tButton(CUIXml& xml_doc, pcstr path, int index, CUI3tButton* pWnd){
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitSound(CUIXml& xml_doc, pcstr path, int index, CUI3tButton* pWnd){
	string256 sound_h;
	string256 sound_t;
...
bool CUIXmlInit::InitButton(CUIXml& xml_doc, pcstr path, int index, CUIButton* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
//////////////////////////////////////////////////////////////////////////
bool CUIXmlInit::InitDragDropListEx(CUIXml& xml_doc, pcstr path, int index, CUIDragDropListEx* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitListWnd(CUIXml& xml_doc, pcstr path, int index, CUIListWnd* pWnd)
{
	R_ASSERT3							(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitProgressBar(CUIXml& xml_doc, pcstr path, int index, CUIProgressBar* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitProgressShape(CUIXml& xml_doc, pcstr path, int index, CUIProgressShape* pWnd){
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
CUIXmlInit::StaticsVec CUIXmlInit::InitAutoStaticGroup(CUIXml& xml_doc, pcstr path, int index, CUIWindow* pParentWnd)
{
...
bool CUIXmlInit::InitFont(CUIXml &xml_doc, pcstr path, int index, u32 &color, CGameFont *&pFnt)
{
...
bool CUIXmlInit::InitTabControl(CUIXml &xml_doc, pcstr path, int index, CUITabControl *pWnd)
{
	R_ASSERT3				(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitFrameLine(CUIXml& xml_doc, pcstr path, int index, CUIFrameLineWnd* pWnd)
{
...
bool CUIXmlInit::InitLabel(CUIXml& xml_doc, pcstr path, int index, CUILabel* pWnd){
...
bool CUIXmlInit::InitCustomEdit(CUIXml& xml_doc, pcstr path, int index, CUICustomEdit* pWnd){
	InitWindow(xml_doc, path, index, pWnd);
...
bool CUIXmlInit::InitEditBoxEx(CUIXml& xml_doc, pcstr path, int index, CUIEditBoxEx* pWnd){
	InitCustomEdit(xml_doc, path, index, pWnd);
	InitTexture(xml_doc, path, index, pWnd);
	return true;
}

bool CUIXmlInit::InitEditBox(CUIXml& xml_doc, pcstr path, int index, CUIEditBox* pWnd){
	InitCustomEdit(xml_doc, path, index, pWnd);
	InitTexture(xml_doc, path, index, pWnd);
	InitOptionsItem(xml_doc, path, index, pWnd);
...
bool CUIXmlInit::InitTextBanner(CUIXml &xml_doc, pcstr path, int index, CUITextBanner *pBnr)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitMultiTextStatic(CUIXml &xml_doc, pcstr path, int index, CUIMultiTextStatic *pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitAnimatedStatic(CUIXml &xml_doc, pcstr path, int index, CUIAnimatedStatic *pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitTexture(CUIXml& xml_doc, pcstr path, int index, IUIMultiTextureOwner* pWnd){
	string256 buf;	
	shared_str texture;
...
bool CUIXmlInit::InitTexture(CUIXml& xml_doc, pcstr path, int index, IUISingleTextureOwner* pWnd){
	string256 buf;
...
bool CUIXmlInit::InitTextureOffset(CUIXml &xml_doc, pcstr path, int index, CUIStatic* pWnd){
...
bool CUIXmlInit::InitMultiTexture(CUIXml &xml_doc, pcstr path, int index, CUI3tButton* pWnd){
	string256 buff;
	bool success = false;
...
bool CUIXmlInit::InitMultiText(CUIXml& xml_doc, pcstr path, int index, CUIStatic* pWnd){
	string256			buf;
...
bool CUIXmlInit::InitAlignment(CUIXml &xml_doc, pcstr path, int index, f32& x, f32& y,CUIWindow* pWnd)
{
...
bool CUIXmlInit::InitScrollView	(CUIXml& xml_doc, pcstr path, int index, CUIScrollView* pWnd)
{
	R_ASSERT3(xml_doc.NavigateToNode(path,index), "XML node not found", path);
...
bool CUIXmlInit::InitListBox(CUIXml& xml_doc, pcstr path, int index, CUIListBox* pWnd){
...
bool CUIXmlInit::InitTrackBar(CUIXml& xml_doc, pcstr path, int index, CUITrackBar* pWnd)
{
...
bool CUIXmlInit::InitComboBox(CUIXml& xml_doc, pcstr path, int index, CUIComboBox* pWnd){
	u32							color;
	CGameFont*					pFont;
...
u32 CUIXmlInit::GetColor(CUIXml& xml_doc, pcstr path, int index, u32 def_clr)
{
