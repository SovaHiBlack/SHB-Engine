...
void CUIVideoPlayerWnd::SendMessage(CUIWindow* pWnd, s16 msg, pvoid pData)
{
...
void CUIVideoPlayerWnd::Init(CUIXml* doc, pcstr start_from)
{
	...
	s32 flag = doc->ReadAttribInt(start_from, 0, "looped", 0);
...
void CUIVideoPlayerWnd::OnTabChanged(CUIWindow* pWnd, pvoid pData)
{
...
bool CUIActorSleepVideoPlayer::OnKeyboard(s32 dik, EUIMessages keyboard_action)
{
