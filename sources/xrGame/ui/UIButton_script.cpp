...
void CUIButton::script_register(lua_State *L)
{
	...
	[
		...
		.def("Init",					(void(CUIButton::*)(const char*,float,float,float,float))&CUIButton::Init )
...
//.		.def("Init",					(void(CUI3tButton::*)(const char*,float,float,float,float))CUI3tButton::Init)
//.		.def("InitTexture",				(void(CUI3tButton::*)(const char*))CUI3tButton::InitTexture)
//.		.def("InitTexture",				(void(CUI3tButton::*)(const char*, const char*, const char*, const char*))CUI3tButton::InitTexture)
