...
void CUICustomMap::Init	(shared_str name, CIniFile& gameLtx, const char* sh_name)
{
	m_name				= name;
	const char* tex;
	Fvector4 tmp;
...
void CUIGlobalMap::Init		(shared_str name, CIniFile& gameLtx, const char* sh_name)
{
...
void CUILevelMap::Init	(shared_str name, CIniFile& gameLtx, const char* sh_name)
{
	inherited::Init(name, gameLtx, sh_name);
...
void CUIMiniMap::Init(shared_str name, CIniFile& gameLtx, const char* sh_name)
{
	inherited::Init(name, gameLtx, sh_name);
