...
void CUICustomMap::Init(CSharedString name, CConfigurationFile& gameLtx, const char* sh_name)
{
	m_name = name;
	const char* tex;
	Fvector4 tmp;
...
void CUICustomMap::SendMessage(CUIWindow* pWnd, signed short msg, void* pData)
{
...
void CUIGlobalMap::Init(CSharedString name, CConfigurationFile& gameLtx, const char* sh_name)
{
...
void CUILevelMap::Init(CSharedString name, CConfigurationFile& gameLtx, const char* sh_name)
{
	inherited::Init(name, gameLtx, sh_name);
...
void CUILevelMap::SendMessage(CUIWindow* pWnd, signed short msg, void* pData)
{
...
void CUIMiniMap::Init(CSharedString name, CConfigurationFile& gameLtx, const char* sh_name)
{
	inherited::Init(name, gameLtx, sh_name);
