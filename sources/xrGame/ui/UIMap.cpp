...
void CUICustomMap::Init(CSharedString name, CIniFile& gameLtx, const char* sh_name)
{
	m_name = name;
	const char* tex;
	Fvector4 tmp;
...
void CUIGlobalMap::Init(CSharedString name, CIniFile& gameLtx, const char* sh_name)
{
...
void CUILevelMap::Init(CSharedString name, CIniFile& gameLtx, const char* sh_name)
{
	inherited::Init(name, gameLtx, sh_name);
...
void CUIMiniMap::Init(CSharedString name, CIniFile& gameLtx, const char* sh_name)
{
	inherited::Init(name, gameLtx, sh_name);
