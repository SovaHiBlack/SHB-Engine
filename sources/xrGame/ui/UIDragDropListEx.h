...
protected:
	...
	void	__stdcall		OnScrollV(CUIWindow* w, pvoid pData);
	void	__stdcall		OnItemStartDragging(CUIWindow* w, pvoid pData);
	void	__stdcall		OnItemDrop(CUIWindow* w, pvoid pData);
	void	__stdcall		OnItemSelected(CUIWindow* w, pvoid pData);
	void	__stdcall		OnItemRButtonClick(CUIWindow* w, pvoid pData);
	void	__stdcall		OnItemDBClick(CUIWindow* w, pvoid pData);
