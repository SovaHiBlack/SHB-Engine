...
CSE_ALifeTraderAbstract* ch_info_get_from_id(unsigned short id)
{
...
CUICharacterInfo::CUICharacterInfo( ) : m_ownerID(unsigned short(-1)), pUIBio(nullptr)
{
...
void CUICharacterInfo::InitCharacter(unsigned short id)
{
	m_ownerID = id;
