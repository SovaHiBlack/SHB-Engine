...
void CUITradeWnd::SendMessage(CUIWindow* pWnd, s16 msg, pvoid pData)
{
...
void CUITradeWnd::PerformTrade( )
{
	...
	s32 our_money = (s32)m_pInvOwner->get_money( );
	s32 others_money = (s32)m_pOthersInvOwner->get_money( );

	s32 delta_price = s32(m_iOurTradePrice - m_iOthersTradePrice);
