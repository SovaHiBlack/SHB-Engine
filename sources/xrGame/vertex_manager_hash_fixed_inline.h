...
TEMPLATE_SPECIALIZATION
inline	typename CHashFixedVertexManager::_path_id_type CHashFixedVertexManager::current_path_id	() const
{
...
TEMPLATE_SPECIALIZATION
inline	typename CHashFixedVertexManager::CGraphVertex &CHashFixedVertexManager::create_vertex	(CGraphVertex &vertex, const _index_type &vertex_id)
{
