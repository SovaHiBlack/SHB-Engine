...
using FvectorVec = xr_vector<Fvector3>;
...
//DEFINE_VECTOR(signed char,S8Vec,S8It);
//DEFINE_VECTOR(signed char*,LPS8Vec,LPS8It);
//DEFINE_VECTOR(signed short,S16Vec,S16It);
//DEFINE_VECTOR(signed short*,LPS16Vec,LPS16It);
//DEFINE_VECTOR(int,S32Vec,S32It);
//DEFINE_VECTOR(int*,LPS32Vec,LPS32It);
//DEFINE_VECTOR(unsigned char,U8Vec,U8It);
//DEFINE_VECTOR(unsigned char*,LPU8Vec,LPU8It);
//DEFINE_VECTOR(unsigned short,U16Vec,U16It);
