...
public:
	...
	unsigned int				line_count(const char* S);
	unsigned int				line_count(const CSharedString& S);
	...
	unsigned short				r_u16(const char* S, const char* L);
	unsigned short				r_u16(const CSharedString& S, const char* L)
	{
		return r_u16(*S, L);
	}
	unsigned int				r_u32(const char* S, const char* L);
	unsigned int				r_u32(const CSharedString& S, const char* L)
	{
		return r_u32(*S, L);
	}
	...
	signed short				r_s16(const char* S, const char* L);
	signed short				r_s16(const CSharedString& S, const char* L)
	{
		return r_s16(*S, L);
	}
	...
	float						r_float(const CSharedString& S, const char* L)
	{
		return r_float(*S, L);
	}
	...
	unsigned int				r_color(const char* S, const char* L);
	unsigned int				r_color(const CSharedString& S, const char* L)
	{
		return r_color(*S, L);
	}
	...
	void						w_u16(const char* S, const char* L, unsigned short V, const char* comment = 0);
	void						w_u32(const char* S, const char* L, unsigned int V, const char* comment = 0);
	void						w_s8(const char* S, const char* L, signed char V, const char* comment = 0);
	void						w_s16(const char* S, const char* L, signed short V, const char* comment = 0);
	...
	void						w_color(const char* S, const char* L, unsigned int V, const char* comment = 0);
