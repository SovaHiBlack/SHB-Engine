...
namespace CPU
{
	CORE_API extern unsigned __int64				clk_per_second;
	CORE_API extern unsigned __int64				clk_per_milisec;
	CORE_API extern unsigned __int64				clk_per_microsec;
	CORE_API extern unsigned __int64				clk_overhead;
...
#pragma warning(disable:4035)
	inline unsigned __int64	GetCLK(void)
	{
		_asm    _emit 0x0F;
		_asm    _emit 0x31;
	}
