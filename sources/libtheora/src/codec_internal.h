...
extern ogg_uint32_t		DPCMTokenizeBlock			(CP_INSTANCE* cpi, ogg_int32_t FragIndex);
...
extern void				UpdateUMVBorder				(PB_INSTANCE* pbi, unsigned char* DestReconPtr);
...
extern void				ScanYUVInit					(PP_INSTANCE* ppi, SCAN_CONFIG_DATA* ScanConfigPtr);
