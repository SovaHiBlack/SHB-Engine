...
#define dsp_recon_inter8x8(funcs, ptr1, ptr2, ptr3, str1)				(funcs.recon_inter8x8 (ptr1, ptr2, ptr3, str1))

#define dsp_recon_inter8x8_half(funcs, ptr1, ptr2, ptr3, ptr4, str1)	(funcs.recon_inter8x8_half (ptr1, ptr2, ptr3, ptr4, str1))
...
#define dsp_sad8x8_xy2_thres(funcs, ptr1, str1, ptr2, ptr3, str2, t)	(funcs.sad8x8_xy2_thres (ptr1, str1, ptr2, ptr3, str2, t))

#define dsp_intra8x8_err(funcs, ptr1, str1)								(funcs.intra8x8_err (ptr1, str1))

#define dsp_inter8x8_err(funcs, ptr1, str1, ptr2, str2)					(funcs.inter8x8_err (ptr1, str1, ptr2, str2))

#define dsp_inter8x8_err_xy2(funcs, ptr1, str1, ptr2, ptr3, str2)		(funcs.inter8x8_err_xy2 (ptr1, str1, ptr2, ptr3, str2))
