...
namespace Feel
{
	...
	struct SFeelParam
	{
		...
		float						vis;
		float						vis_threshold;
		SFeelParam(Vision* _parent, Vision::feel_visible_Item* _item, float _vis_threshold) :parent(_parent), item(_item), vis(1.0f), vis_threshold(_vis_threshold)
		{ }
	};
	inline BOOL feel_vision_callback(collide::rq_result& result, LPVOID params)
	{
