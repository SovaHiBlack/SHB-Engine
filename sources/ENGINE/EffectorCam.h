...
public:
								CEffectorCam				(ECameraEffectorType type, float tm)
	{
		eType = type; fLifeTime = tm;
	}
								CEffectorCam				( )
	{
		eType = (ECameraEffectorType) 0;
		fLifeTime = 0.0f;
	}
	virtual						~CEffectorCam				( )
	{ }
	void						SetType						(ECameraEffectorType type)
	{
		eType = type;
	}
	inline ECameraEffectorType	GetType						( )
	{
		return eType;
	}
	virtual BOOL				Valid						( )
	...
	inline virtual BOOL			Overlapped					( )
	{
		return FALSE;
	}
