...
const unsigned short	xrOGF_SMParamsVersion	= 4;

// OGF_DESC
struct ogf_desc	{
	CSharedString	source_file;
	CSharedString	build_name;
	time_t		build_time;
	CSharedString	create_name;
	time_t		create_time;
	CSharedString	modif_name;
	time_t		modif_time;
...
struct ogf_header {
	...
	unsigned short			shader_id;				// should not be ZERO
	ogf_bbox	bb;
	ogf_bsphere	bs;
};
