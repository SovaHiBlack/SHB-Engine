...
void CGameFont::Initialize(const char* cShader, const char* cTextureName)
{
	...
	CConfigurationFile* ini				= CConfigurationFile::Create(fn);
...
void CGameFont::MasterOut(BOOL bCheckDevice, BOOL bUseCoords, BOOL bScaleCoords, BOOL bUseSkip, float _x, float _y, float _skip, const char* fmt, va_list p)
{
