...
public:
	...
	void					CreateFromData(D3DPRIMITIVETYPE _pt, u32 _p_cnt, u32 FVF, void* vertices, u32 _v_cnt, unsigned short* indices=0, u32 _i_cnt=0);
	void					Destroy();
...
public:
	...
	virtual void __stdcall dbgDrawPlacement(const Fvector3& p, int sz, u32 clr, const char* caption=0, u32 clr_font=0xffffffff);
	virtual void __stdcall dbgDrawVert(const Fvector3& p0, u32 clr, const char* caption=0);
	virtual void __stdcall dbgDrawEdge(const Fvector3& p0,	const Fvector3& p1, u32 clr, const char* caption=0);
	virtual void __stdcall dbgDrawFace(const Fvector3& p0,	const Fvector3& p1, const Fvector3& p2, u32 clr, const char* caption=0);
	...
	virtual void __stdcall OutText	(const Fvector3& pos, const char* text, u32 color=0xFF000000, u32 shadow_color=0xFF909090);
