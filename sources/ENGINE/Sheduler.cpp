...
float psShedulerCurrent = 10.0f;
float psShedulerTarget = 10.0f;
...
bool CSheduler::Registered(ISheduled* object) const
{
...

	{
		...
		ItemsVec::const_iterator E = ItemsRT.end( );
		for (; I != E; ++I)
		{
			if ((*I).Object == object)
			{
//				Msg("0x%8x found in RT", object);
	...
	{
		ItemsVec::const_iterator I = Items.begin( );
		ItemsVec::const_iterator E = Items.end( );
		for (; I != E; ++I)
		{
			if ((*I).Object == object)
			{
//				Msg("0x%8x found in non-RT", object);
	...
	{
		ItemsVec::const_iterator I = ItemsProcessed.begin( );
		ItemsVec::const_iterator E = ItemsProcessed.end( );
		for (; I != E; ++I)
		{
			if ((*I).Object == object)
			{
//				Msg("0x%8x found in process items", object);
	...
	using ItemsRegVec = xr_vector<ItemReg>;
	ItemsRegVec::const_iterator I = Registration.begin( );
	ItemsRegVec::const_iterator E = Registration.end( );
	for (; I != E; ++I)
	{
		if ((*I).Object == object)
		{
...
void CSheduler::Update( )
{
	...
	clamp(psShedulerTarget, 3.0f, 66.0f);
