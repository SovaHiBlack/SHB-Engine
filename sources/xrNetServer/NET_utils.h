...
public:
	...
	IC void w_vec3		( const fVector3& a) { w(&a,3*sizeof(f32));	}			// vec3
	...
	// reading - utilities
	IC void		r_vec3			(fVector3& A)	{ r(&A,3*sizeof(f32));		} // vec3
	...
	IC fVector3	r_vec3			()		{fVector3 A;r(&A,3*sizeof(f32));	return(A);		} // vec3
