...
//----------------------------------------------------
IC void FillSprite(FVF::LIT*& pv, const fVector3& T, const fVector3& R, const fVector3& pos, const fVector2& lt, const fVector2& rb, f32 r1, f32 r2, u32 clr, f32 angle)
{
	f32 sa = _sin(angle);
	f32 ca = _cos(angle);
	fVector3 Vr;
...
IC void FillSprite(FVF::LIT*& pv, const fVector3& pos, const fVector3& dir, const fVector2& lt, const fVector2& rb, f32 r1, f32 r2, u32 clr, f32 angle)
{
	f32 sa = _sin(angle);
	f32 ca = _cos(angle);
