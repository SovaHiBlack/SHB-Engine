...
short QC(f32 v)
{
	s32 t = iFloor(v * f32(quant)); clamp(t, -32768, 32767);
...
void CDetailManager::hw_Load( )
{
	...
	{
		vertHW* pV;
		R_CHK(hw_VB->Lock(0, 0, (pvoid*)&pV, 0));
...
void CDetailManager::hw_Render( )
{
	...
	// Wave0
	f32		scale = 1.0f / f32(quant);
	fVector4	wave;
	wave.set(1.0f / 5.0f, 1.0f / 7.0f, 1.0f / 3.0f, Device.fTimeGlobal * swing_current.speed);
	...
	// Wave1
	wave.set(1.0f / 3.0f, 1.0f / 7.0f, 1.0f / 5.0f, Device.fTimeGlobal * swing_current.speed);
	RCache.set_c(&*hwc_wave, wave.div(PI_MUL_2));	// wave
