...
void CParticleGroup::SItem::StartRelatedChild(CParticleEffect* emitter, const char* eff_name, PAPI::SParticle& m)
{
...
void CParticleGroup::SItem::StartFreeChild(CParticleEffect* emitter, const char* nm, PAPI::SParticle& m)
{
