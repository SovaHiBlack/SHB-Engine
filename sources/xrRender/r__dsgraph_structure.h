...
{
public:
	virtual		void	rfeedback_static	(IRenderVisual*	V)		= 0;
};
...
public:
	...
	xr_vector<IRenderVisual*,render_alloc<IRenderVisual*> >			lstVisuals	;

	xr_vector<IRenderVisual*,render_alloc<IRenderVisual*> >			lstRecorded	;
...
public:
	...
	void		r_dsgraph_insert_dynamic(IRenderVisual* pVisual, fVector3& Center);
	void		r_dsgraph_insert_static(IRenderVisual* pVisual);
