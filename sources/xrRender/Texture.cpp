...
{
	CConfigurationFile::Sect& sect = pSettings->r_section("reduce_lod_texture_list");
	CConfigurationFile::SectCIt it_ = sect.Data.begin( );
	CConfigurationFile::SectCIt it_e_ = sect.Data.end( );

	CConfigurationFile::SectCIt it = it_;
	CConfigurationFile::SectCIt it_e = it_e_;
