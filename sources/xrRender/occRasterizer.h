...
public:
	...
	inline signed short			df_2_s16		(float d)	{ return signed short(iFloor	(d*occQ_s16));			}
	inline int			df_2_s32up		(float d)	{ return iCeil	(d*occQ_s32);				}
	inline signed short			df_2_s16up		(float d)	{ return signed short(iCeil	(d*occQ_s16));			}
	inline float		ds32_2_f		(int d)		{ return float(d)/occQ_s32;					}
	inline float		ds16_2_f		(signed short d)		{ return float(d)/occQ_s16;					}
