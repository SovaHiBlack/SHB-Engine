...
public:
	...
	// fpu
	__forceinline BOOL		_box_fpu	(const Fvector3& bCenter, const Fvector3& bExtents, Fvector3& coord)
	{
		Fbox3		BB;
	...
	// sse
	__forceinline BOOL		_box_sse	(const Fvector3& bCenter, const Fvector3& bExtents, float&  dist )
	{
		aabb_t		box;
