...
namespace CDB
{
	...
	public:
		void			add_face			( const Fvector3& v0, const Fvector3& v1, const Fvector3& v2, unsigned short material, unsigned short sector	);
		void			add_face_D			( const Fvector3& v0, const Fvector3& v1, const Fvector3& v2, u32 dummy );
		void			add_face_packed		( const Fvector3& v0, const Fvector3& v1, const Fvector3& v2, unsigned short material, unsigned short sector, float eps = EPS );
