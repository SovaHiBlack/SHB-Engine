...
// To offset [0 .. 1] vectors to [-0.5 .. 0.5]
static CParticleVector vHalf(0.5f, 0.5f, 0.5f);

__forceinline CParticleVector RandVec( )
{
...
SParticleDomain::SParticleDomain(EParticleDomain dtype,
...
void SParticleDomain::Generate(CParticleVector& pos) const
{
	switch (type)
	{
		...
		default:
		{
			pos = CParticleVector(0.0f, 0.0f, 0.0f);
		}
	}
}
